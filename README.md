...
Note that the user login for this project was 'igneus' and this appears in some of the code for file paths. If your username isn't 'igneus' then replace this with whatever your username is, e.g., 'pi'.
